   ...
   {    
       case "single.php":
        ...
        else
        {
            ...
            {
                $page_title ="no search resutlt found";
            ...
            <?php
                          ...
                          if(mysqli_num_rows($result) > 0){
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                {
                                        echo '<a href="index.php" id ="logo"><img class="logo" src="admin/images/'.$row['logo'].'"></a>';
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
               <ul class ='menu'>
               <li><a href='http://localhost:8080/sanyiam/phppractice1/newsproject/index.php'>Home</a></li> 
